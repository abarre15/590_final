---
title: "2017_04_26 manuscript script"
author: "Abby"
date: "April 26, 2017"
...
# Make sure to describe what script(s) you have to run to get to this point

#combine all the data frames from the thesis work 
cd <- read.csv("../data/2017_04_28 combined raw EEC data.csv")

#########
# manipulate enzyme data
#########

#rename by enzyme type
cd$enzyme.type <- revalue(cd$substrate, c("Arg-AMC"="peptidase", "Gly-AMC"="peptidase", "Leu-AMC"="peptidase", "Pyr-AMC"="peptidase", "GGR-AMC"="peptidase", "MUB-gluco"="glucosidase","MUB-Phos"="phosphatase"))
#endo or exo
cd$enzyme.class <- revalue(cd$substrate, c("Arg-AMC"="exopeptidase", "Gly-AMC"="exopeptidase", "Leu-AMC"="exopeptidase", "Pyr-AMC"="exopeptidase", "GGR-AMC"="endopeptidase", "MUB-gluco"="glucosidase","MUB-Phos"="phosphatase"))

#add site type to each sample site 
cd$site.type <-revalue(cd$site, c("victor ashe" = "pond",
                                  "third creek" = "creek", 
                                  "clinton city park" = "river",
                                  "clinch river" = "river",
                                  "cove lake" = "lake", 
                                  "norris dam" = "river",
                                  "volunteer landing" = "river",
                                  "second creek" = "creek",
                                  "anchor down" = "lake",
                                  "douglas dam" = "river",
                                  "chilowee park" = "pond",
                                  "holston hills park" = "river",
                                  "fort dickerson" = "quarry",
                                  "ut med pond" = "pond",
                                  "cherokee reservoir" = "lake", 
                                  "mossy spring" = "creek",
                                  "little river" = "river", 
                                  "west prong" = "river", 
                                  "tyson park" = "creek",
                                  "sequoyah hills" = "river",
                                  "fish pond" = "pond", 
                                  "bb1" = "pond", 
                                  "bb2" = "pond", 
                                  "pickerel pond" = "pond",
...
#rename replicate live or kill 
cd$replicate2<- cd$replicate
cd$treatment <- revalue(cd$replicate, c("1"="live", "2"="live", "3"="live", "k"="control"))

##########
#get stats for enzyme data
##########

#apply ddply to get stats on the data, mean, sum, standard deviation, ymin, ymax
v0_summ <- ddply(cd, c("site", "sample.type", "substrate", "enzyme.type", "enzyme.class", "treatment", "site.type","slope.se", "replicate2"),
                 summarise,
...
#calcualte the the killed control value 
kc <- ddply(v0_summ[v0_summ$treatment=="control", ], c("substrate", "site", "sample.type", "slope.se", "replicate2"), 
            summarise,
            kc=mean(mean.v0, na.rm=TRUE))

#merge kill control with v0_summ
v0_summ.kc <- merge(v0_summ, kc, by = c("substrate", "site", "sample.type"), all = TRUE)

#subtract the v0 live-v0 kill and add new column (kc.v0)
v0_summ.kc$kc.v0<- v0_summ.kc$mean.v0- v0_summ.kc$kc
#name site loaction 
v0_summ.kc$site.location<-v0_summ.kc$site.location.x
```
